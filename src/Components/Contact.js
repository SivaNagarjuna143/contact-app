...
import { getAllContacts } from "../redux/actions/contacts-action";
import AddEditContact from "./AddEditContact";
import { getSingleContact,deleteContact } from "../redux/actions/contacts-action";
function Contact({ getAllContacts, contacts, getSingleContact,contact ,deleteContact}) {
  useEffect(() => {
    getAllContacts();
  }, []);
  const handleDelete=(index)=>{
    const confirm=window.confirm("Are you sure want delete?");
    if(confirm){
deleteContact(index)
    }
  }
